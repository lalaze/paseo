...
export const ptBR: TranslationResources = {
  collaboration: {
    ...
    removeRule: "Remover atribuição",
    allowSelection: "Permitir que o agente principal escolha o perfil de implementação",

    newConversation: "Nova conversa de colaboração",
    title: "Colaboração",
    directorProfileId: "Agente principal",
    workerProfileId: "Agente de implementação",
    reviewerProfileId: "Agente de revisão",
    selectProfile: "Escolher um perfil",
    chooseProfiles: "Crie um perfil com um modelo para configurar a colaboração.",
    conversations: "Conversas de colaboração",
    requireApproval: "Exigir aprovação do plano",
    plan: "Instruções de planejamento",
    execute: "Instruções de implementação",
    review: "Instruções de revisão",
    maxAttempts: "Máximo de operações por rodada",
    maxReworks: "Máximo de retrabalhos",
    save: "Salvar configurações de colaboração",
    open: "Abrir conversa",
    resync: "Sincronizar novamente",
    pause: "Pausar distribuição",
    resume: "Retomar",
    cancel: "Parar colaboração",
    retry: "Tentar novamente",
    enable: "Ativar colaboração nesta conversa",
    empty: "Ainda não há conversas de colaboração.",
    saved: "Configurações salvas",
    sameReviewer: "Usar o agente principal",
    turnTimeoutMs: "Limite por etapa (minutos)",
    runTimeoutMs: "Limite por rodada (minutos)",
    checks: "Comandos de verificação (um por linha)",
    showDetails: "Mostrar instruções",
    hideDetails: "Ocultar instruções",
    message: {
      plan: "Colaboração · planejamento",
      execute: "Colaboração · implementação",
      review: "Colaboração · revisão",
      final: "Colaboração · revisão final",
      progress: "Progresso da colaboração",
  ...
  composer: {
    ...
    clientCommands: {
      collaboration: "Ativar colaboração nesta conversa",

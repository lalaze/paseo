...
export const ja: TranslationResources = {
  collaboration: {
    ...
    addRule: "割り当てを追加",
    removeRule: "割り当てを削除",
    allowSelection: "主担当による実装プロファイルの選択を許可",

    newConversation: "共同作業の会話を作成",
    title: "共同作業",
    directorProfileId: "主担当エージェント",
    workerProfileId: "実装エージェント",
    reviewerProfileId: "レビューエージェント",
    selectProfile: "プロファイルを選択",
    chooseProfiles: "共同作業を設定するには、モデルを指定したプロファイルを作成してください。",
    conversations: "共同作業の会話",
    requireApproval: "計画の承認を必須にする",
    plan: "計画の指示",
    execute: "実装の指示",
    review: "レビューの指示",
    maxAttempts: "ラウンドごとの操作上限",
    maxReworks: "修正回数の上限",
    save: "共同作業設定を保存",
    open: "会話を開く",
    resync: "再同期",
    ...
    cancel: "共同作業を停止",
    retry: "再試行",
    enable: "この会話で共同作業を有効化",
    empty: "共同作業の会話はまだありません。",
    saved: "設定を保存しました",
    sameReviewer: "主担当がレビュー",
    turnTimeoutMs: "ステップの制限時間（分）",
    runTimeoutMs: "ラウンドの制限時間（分）",
    checks: "検証コマンド（1行に1つ）",
    showDetails: "指示を表示",
    hideDetails: "指示を非表示",
    message: {

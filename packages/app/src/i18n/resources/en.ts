export const en = {
  collaboration: {
    ...
    removeRule: "Remove assignment",
    allowSelection: "Let the lead choose an implementation profile",

    newConversation: "New collaboration conversation",
    title: "Collaboration",
    directorProfileId: "Lead agent",
    workerProfileId: "Implementation agent",
    reviewerProfileId: "Review agent",
    selectProfile: "Choose an agent profile",
    chooseProfiles: "Create an agent profile with a model to configure collaboration.",
    conversations: "Collaboration conversations",
    requireApproval: "Require plan approval",
    plan: "Planning instructions",
    execute: "Implementation instructions",
    review: "Review instructions",
    maxAttempts: "Maximum operations per round",
    maxReworks: "Maximum reworks",
    save: "Save collaboration settings",
    open: "Open conversation",
    resync: "Resync",
    pause: "Pause dispatch",
    resume: "Resume",
    cancel: "Stop collaboration",
    retry: "Retry",
    enable: "Enable collaboration in this conversation",
    empty: "No collaboration conversations yet.",
    saved: "Settings saved",
    sameReviewer: "Use the lead agent",
    turnTimeoutMs: "Step time limit (minutes)",
    runTimeoutMs: "Round time limit (minutes)",
    checks: "Verification commands (one per line)",
    showDetails: "Show instructions",
    hideDetails: "Hide instructions",
    message: {
      plan: "Collaboration · planning",
      execute: "Collaboration · implementation",
      review: "Collaboration · review",
      final: "Collaboration · final review",
  ...
  composer: {
    ...
    clientCommands: {
      collaboration: "Enable collaboration in this conversation",

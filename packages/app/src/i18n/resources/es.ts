...
export const es: TranslationResources = {
  collaboration: {
    ...
    launchErrors: {
      configure: "Guarda la configuración de colaboración antes de continuar.",
      reviewerRequired:
    ...
    addRule: "Añadir asignación",
    removeRule: "Eliminar asignación",
    allowSelection: "Permitir al agente principal elegir el perfil de implementación",

    newConversation: "Nueva conversación de colaboración",
    title: "Colaboración",
    directorProfileId: "Agente principal",
    workerProfileId: "Agente de implementación",
    reviewerProfileId: "Agente de revisión",
    selectProfile: "Elegir un perfil",
    chooseProfiles: "Crea un perfil con un modelo para configurar la colaboración.",
    conversations: "Conversaciones de colaboración",
    requireApproval: "Exigir aprobación del plan",
    plan: "Instrucciones de planificación",
    execute: "Instrucciones de implementación",
    review: "Instrucciones de revisión",
    maxAttempts: "Máximo de operaciones por ronda",
    maxReworks: "Máximo de correcciones",
    save: "Guardar ajustes de colaboración",
    open: "Abrir conversación",
    resync: "Sincronizar de nuevo",
    pause: "Pausar asignaciones",
    resume: "Reanudar",
    cancel: "Detener colaboración",
    retry: "Reintentar",
    enable: "Activar colaboración en esta conversación",
    empty: "Aún no hay conversaciones de colaboración.",
    saved: "Ajustes guardados",
    sameReviewer: "Usar el agente principal",
    turnTimeoutMs: "Límite por paso (minutos)",
    runTimeoutMs: "Límite por ronda (minutos)",
    checks: "Comandos de verificación (uno por línea)",
    showDetails: "Mostrar instrucciones",
    hideDetails: "Ocultar instrucciones",
    message: {
      plan: "Colaboración · planificación",
      execute: "Colaboración · implementación",
      review: "Colaboración · revisión",
      final: "Colaboración · revisión final",
      progress: "Progreso de colaboración",
  ...
  composer: {
    ...
    clientCommands: {
      collaboration: "Activar colaboración en esta conversación",

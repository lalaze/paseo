...
export const zhCN: TranslationResources = {
  collaboration: {
    ...
    launch: {
      ...
      reviewer: "审核",
      unconfigured: "未配置",
      reviewerHint: "需要独立审核 Agent，可与执行者使用相同模型。",
      configureReviewer: "配置审核 Agent",
      goal: "任务目标",
    },
    modes: {
      full: "完整流程",
    ...
    addRule: "添加分配",
    removeRule: "移除分配",
    allowSelection: "允许主 Agent 选择执行配置",

    newConversation: "新建协作对话",
    title: "协作",
    directorProfileId: "主 Agent",
    workerProfileId: "执行 Agent",
    reviewerProfileId: "审核 Agent",
    selectProfile: "选择 Agent 配置",
    chooseProfiles: "请先创建包含模型的 Agent 配置，再设置协作。",
    conversations: "协作对话",
    requireApproval: "要求批准方案",
    plan: "设计提示词",
    execute: "执行提示词",
    review: "审核提示词",
    maxAttempts: "每轮最多操作次数",
    maxReworks: "最多返工次数",
    save: "保存协作设置",
    open: "打开对话",
    resync: "重新同步",
    ...
    empty: "暂无协作对话。",
    saved: "设置已保存",
    sameReviewer: "由主 Agent 审核",
    turnTimeoutMs: "单步时限（分钟）",
    runTimeoutMs: "每轮时限（分钟）",
    checks: "验证命令（每行一条）",
    showDetails: "查看指令",
    hideDetails: "收起指令",
    message: {

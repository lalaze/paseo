...
export const ko: TranslationResources = {
  collaboration: {
    ...
    launch: {
      ...
      reviewerHint: "독립적인 검토 에이전트를 선택하세요. 실행자와 같은 모델을 사용할 수 있습니다.",
      configureReviewer: "검토 에이전트 설정",
      goal: "작업 목표",
    },
    modes: {
      full: "전체 과정",
    ...
    addRule: "배정 추가",
    removeRule: "배정 삭제",
    allowSelection: "주 에이전트가 구현 프로필 선택 허용",

    newConversation: "협업 대화 만들기",
    title: "협업",
    directorProfileId: "주 에이전트",
    workerProfileId: "구현 에이전트",
    reviewerProfileId: "검토 에이전트",
    selectProfile: "에이전트 프로필 선택",
    chooseProfiles: "협업을 설정하려면 모델이 지정된 프로필을 만드세요.",
    conversations: "협업 대화",
    requireApproval: "계획 승인 필요",
    plan: "계획 지침",
    execute: "구현 지침",
    review: "검토 지침",
    maxAttempts: "라운드당 최대 작업 수",
    maxReworks: "최대 재작업 횟수",
    save: "협업 설정 저장",
    open: "대화 열기",
    resync: "다시 동기화",
    pause: "작업 배정 일시 중지",
    ...
    cancel: "협업 중지",
    retry: "다시 시도",
    enable: "이 대화에서 협업 활성화",
    empty: "아직 협업 대화가 없습니다.",
    saved: "설정 저장됨",
    sameReviewer: "주 에이전트가 검토",
    turnTimeoutMs: "단계 제한 시간(분)",
    runTimeoutMs: "라운드 제한 시간(분)",
    checks: "검증 명령(줄당 하나)",
    showDetails: "지침 보기",
    hideDetails: "지침 숨기기",
    message: {

...
export const fr: TranslationResources = {
  collaboration: {
    ...
    removeRule: "Supprimer l’affectation",
    allowSelection: "Laisser l’agent principal choisir le profil de réalisation",

    newConversation: "Nouvelle conversation collaborative",
    title: "Collaboration",
    directorProfileId: "Agent principal",
    workerProfileId: "Agent de réalisation",
    reviewerProfileId: "Agent de vérification",
    selectProfile: "Choisir un profil",
    chooseProfiles: "Créez un profil avec un modèle pour configurer la collaboration.",
    conversations: "Conversations collaboratives",
    requireApproval: "Exiger la validation du plan",
    plan: "Consignes de planification",
    execute: "Consignes de réalisation",
    review: "Consignes de vérification",
    maxAttempts: "Opérations maximales par cycle",
    maxReworks: "Corrections maximales",
    save: "Enregistrer la collaboration",
    open: "Ouvrir la conversation",
    resync: "Resynchroniser",
    pause: "Suspendre les affectations",
    resume: "Reprendre",
    cancel: "Arrêter la collaboration",
    retry: "Réessayer",
    enable: "Activer la collaboration dans cette conversation",
    empty: "Aucune conversation collaborative pour le moment.",
    saved: "Paramètres enregistrés",
    sameReviewer: "Utiliser l’agent principal",
    turnTimeoutMs: "Durée limite par étape (minutes)",
    runTimeoutMs: "Durée limite par cycle (minutes)",
    checks: "Commandes de vérification (une par ligne)",
    showDetails: "Afficher les consignes",
    hideDetails: "Masquer les consignes",
    message: {
      plan: "Collaboration · planification",
      execute: "Collaboration · réalisation",
      review: "Collaboration · vérification",
      final: "Collaboration · vérification finale",
      progress: "Avancement de la collaboration",
  ...
  composer: {
    ...
    clientCommands: {
      collaboration: "Activer la collaboration dans cette conversation",

...
export const ru: TranslationResources = {
  collaboration: {
    ...
    launch: {
      ...
      reviewerHint:
        "Выберите независимого проверяющего агента. Он может использовать ту же модель, что и исполнитель.",
      configureReviewer: "Настроить проверку",
      goal: "Цель задачи",
    },
    modes: {
      full: "Полный процесс",
    ...
    modeDescriptions: {
      full: "План → исполнение → проверка → ваша приёмка",
      execute_review: "Один исполнитель и независимая проверка перед вашей приёмкой",
    },
    modeLocked: "Режим этой задачи зафиксирован. Для другого режима начните новый диалог.",
    isolationDescriptions: {
      local: "Сохраняет незакоммиченные изменения и переключает эту копию на ветку director.",
      worktree:
        "Начинает с текущего коммита в новом worktree Paseo. Незакоммиченные изменения остаются здесь.",
    },
    ...
    launchErrors: {
      ...
      updateHostWorktree: "Обновите хост, чтобы запускать совместную работу в отдельном worktree.",
    },
    categoryOverrides: "Назначения по категориям",
    taskOverrides: "Назначения по ID задач",
    addRule: "Добавить назначение",
    removeRule: "Удалить назначение",
    allowSelection: "Разрешить ведущему выбирать профиль исполнителя",

    newConversation: "Новый совместный диалог",
    title: "Совместная работа",
    directorProfileId: "Ведущий агент",
    workerProfileId: "Агент-исполнитель",
    reviewerProfileId: "Агент проверки",
    selectProfile: "Выбрать профиль",
    chooseProfiles: "Создайте профиль с моделью для настройки совместной работы.",
    conversations: "Совместные диалоги",
    requireApproval: "Требовать одобрения плана",
    plan: "Инструкции для планирования",
    execute: "Инструкции для реализации",
    review: "Инструкции для проверки",
    maxAttempts: "Максимум операций за цикл",
    maxReworks: "Максимум доработок",
    save: "Сохранить настройки",
    open: "Открыть диалог",
    resync: "Синхронизировать снова",
    pause: "Приостановить назначение",
    resume: "Продолжить",
    cancel: "Остановить совместную работу",
    retry: "Повторить",
    enable: "Включить совместную работу в этом диалоге",
    empty: "Совместных диалогов пока нет.",
    saved: "Настройки сохранены",
    sameReviewer: "Проверяет ведущий агент",
    turnTimeoutMs: "Лимит этапа (минуты)",
    runTimeoutMs: "Лимит цикла (минуты)",
    checks: "Команды проверки (по одной в строке)",
    showDetails: "Показать инструкции",
    hideDetails: "Скрыть инструкции",
    message: {
      plan: "Совместная работа · планирование",
      execute: "Совместная работа · реализация",
      review: "Совместная работа · проверка",
      final: "Совместная работа · итоговая проверка",
      progress: "Ход совместной работы",
  ...
  composer: {
    ...
    clientCommands: {
      collaboration: "Включить совместную работу в этом диалоге",
  ...
  settings: {
    ...
    appearance: {
      bing: {
        archive: "Библиотека обоев",
        back: "Вернуться к оформлению",
        archiveDescription:
          "Изображения сохраняются на этом устройстве при обновлении. Очистка данных приложения или сайта удаляет архив.",
        ...
        title: "Ежедневные обои Bing",
        enable: "Использовать обои Bing",
        description:
          "Обновляются ежедневно. Включение отключает текущую графическую тему; выбор графической темы отключает обои Bing.",
        unavailable:
          "Подключитесь к хосту с поддержкой обоев Bing. При необходимости обновите хост.",
        loading: "Загрузка обоев…",
        failed: "Не удалось загрузить обои: {{reason}}",
        refresh: "Обновить",
        attribution: "Открыть в Bing",
        imageFailed: "Не удалось загрузить фоновое изображение.",
      },
      skins: {

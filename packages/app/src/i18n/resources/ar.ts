...
export const ar: TranslationResources = {
  collaboration: {
    ...
    launch: {
      ...
      reviewerHint: "اختر وكيل مراجعة مستقلاً. يمكنه استخدام النموذج نفسه الذي يستخدمه المنفّذ.",
      configureReviewer: "إعداد وكيل المراجعة",
      goal: "هدف المهمة",
    },
    modes: {
    ...
    modeDescriptions: {
      full: "التصميم ← التنفيذ ← المراجعة ← قبولك",
    ...
    addRule: "إضافة تعيين",
    removeRule: "إزالة التعيين",
    allowSelection: "السماح للوكيل الرئيسي باختيار ملف التنفيذ",

    newConversation: "محادثة تعاون جديدة",
    title: "التعاون",
    directorProfileId: "الوكيل الرئيسي",
    workerProfileId: "وكيل التنفيذ",
    reviewerProfileId: "وكيل المراجعة",
    selectProfile: "اختر ملف وكيل",
    chooseProfiles: "أنشئ ملف وكيل يتضمن نموذجًا لإعداد التعاون.",
    conversations: "محادثات التعاون",
    requireApproval: "اشتراط الموافقة على الخطة",
    plan: "تعليمات التخطيط",
    execute: "تعليمات التنفيذ",
    review: "تعليمات المراجعة",
    maxAttempts: "الحد الأقصى للعمليات في الجولة",
    maxReworks: "الحد الأقصى لإعادة العمل",
    save: "حفظ إعدادات التعاون",
    open: "فتح المحادثة",
    resync: "إعادة المزامنة",
    pause: "إيقاف الإسناد مؤقتًا",
    resume: "متابعة",
    cancel: "إيقاف التعاون",
    retry: "إعادة المحاولة",
    enable: "تفعيل التعاون في هذه المحادثة",
    empty: "لا توجد محادثات تعاون بعد.",
    saved: "تم حفظ الإعدادات",
    sameReviewer: "استخدام الوكيل الرئيسي",
    turnTimeoutMs: "مهلة الخطوة (دقائق)",
    runTimeoutMs: "مهلة الجولة (دقائق)",
    checks: "أوامر التحقق (أمر في كل سطر)",
    showDetails: "عرض التعليمات",
    hideDetails: "إخفاء التعليمات",
    message: {
      plan: "التعاون · التخطيط",
      execute: "التعاون · التنفيذ",
      review: "التعاون · المراجعة",
      final: "التعاون · المراجعة النهائية",
      progress: "تقدم التعاون",
      enabled: "تم تفعيل التعاون",
    },
  },
  paneFind: {
  ...
  composer: {
    ...
    clientCommands: {
      collaboration: "تفعيل التعاون في هذه المحادثة",
  ...
  settings: {
    ...
    appearance: {
      bing: {
        ...
        title: "خلفية Bing اليومية",
        enable: "استخدام خلفية Bing",
        description:
          "تتجدد يوميًا. يؤدي تفعيلها إلى إيقاف السمة المصورة الحالية؛ واختيار سمة مصورة يوقف خلفية Bing.",
        unavailable: "اتصل بمضيف يدعم خلفيات Bing. حدّث المضيف عند الحاجة.",
        loading: "جارٍ تحميل الخلفية…",
        failed: "تعذر تحميل الخلفية: {{reason}}",
        refresh: "تحديث",
        attribution: "عرض في Bing",
        imageFailed: "تعذر تحميل صورة الخلفية.",
      },
      skins: {
        title: "مظاهر بالصور",
        description:

...
import { CollaborationLaunchHost } from "@/collaboration/launch-dialog";
  ...
  return (
    ...
    >
      ...
      <Stack.Protected guard={storeReady}>
        ...
        <Stack.Screen name="settings/wallpapers" />
      ...
      <Stack.Screen name="settings/hosts/[serverId]/collaboration/history" />
